...
- Why Least **Squares**?? (e.g., why minimize squared error rather than absolute error?)
  + There are a few reasons, but the most important is it's useful for the math
- So to derive the estimator, we define the sum of squared errors, $S = \sum \left( y_i - \beta_0 - \beta_1 x_i \right)^2$
